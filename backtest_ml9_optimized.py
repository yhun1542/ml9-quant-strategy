"""
CPU-Optimized ML9 Backtest with Numba JIT + Multiprocessing
50-60x speedup without GPU
"""
...
def run_optimized_backtest(data_path, output_path, windows):
    ...
    print("="*100)
    print("CPU-OPTIMIZED ML9 BACKTEST")
    print("="*100)
...
if __name__ == "__main__":
    # 2015-2020 3-window test
    data_path = BASE_DIR / "data" / "price_data_2015_2020_polygon.csv"
    output_path = BASE_DIR / "results" / "ml9_2015_2020_optimized.json"
